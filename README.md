...
1. Download the [static library for iOS](http://dropbox.rock-n-co.de/marvelous/libMarvelous-0.7.1.zip) or the [framework for OSX](http://dropbox.rock-n-co.de/marvelous/Marvelous-0.7.1.zip).
